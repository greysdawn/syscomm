...
function sroom:enter()
  ...
  bg=SBox:new{c={255,255,255,255},c2={255,255,255,255},text="",x=100,y=100,w=ww-200,h=wh-200,fetchcode="bg"}
  seb=SBox:new{c={0,0,0,0},c2={0,0,0,0},tc={255,0,0,255},text="Please make sure all values are correct rgba values.",ts=18,x=120,y=120,hidden=true,w=500,h=20,fetchcode="seb"}
  seb2=SBox:new{c={0,0,0,0},c2={0,0,0,0},tc={255,0,0,255},text="",ts=18,x=120,y=150,hidden=false,w=500,h=20,fetchcode="seb2"}
  csb=SBox:new{c={200,255,255,255},c2={200,255,255,255},text="background color",x=120,y=200,w=140,h=20,fetchcode="csb"}
  rbx=IBox:new{chars={},c={200,200,200,255},max=3,x=300,y=200,w=50,h=20,updtext=function(self,key)
  ...
  ncsb=SBox:new{c={200,255,255,255},c2={200,255,255,255},text="note bg color",x=120,y=250,w=140,h=20,fetchcode="ncsb"}
  ...
  tcsb=SBox:new{c={200,255,255,255},c2={200,255,255,255},text="note text color",x=120,y=300,w=140,h=20,text="note text color",fetchcode="tcsb"}
  ...
  ssv=Button:new{text="save",x=ww/2-150,y=350,w=50,h=20,onclick=function()
  ...
  scn=Button:new{text="cancel",x=ww/2+100,y=350,w=50,h=20,onclick=function()
    Gamestate.switch(notesroom)
  end,fetchcode="scn"}
end
